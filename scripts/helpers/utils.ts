...
export async function waitForTxWithConsole(tx: Promise<ContractTransaction>) {
  await (await tx.then(console.log));
}
//0xf3b9f5a713f9e12b11eaa303fcb3da3f10257c8fe3d5fe6e849bc685cf9ef1d0
